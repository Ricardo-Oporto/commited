...
- Generate an explanatory body that summarises the change, rationale, and impact.
...
### Phase 5 – Source Control experience
...
2. **AI fallback?** – Should the extension optionally call Copilot or Azure OpenAI for the narrative body?
